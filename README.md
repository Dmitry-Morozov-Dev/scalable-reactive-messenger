...
**Цель:** Максимальная масштабируемость и распределение нагрузки для high-load сценариев (например, 100k+ одновременных WebSocket-соединений, доставка сообщений <100 мс). Проект — мой hands-on опыт для изучения distributed systems, как в Telegram, Discord или WhatsApp. Я начал с базового мессенджера, но перестроил под реактивную архитектуру с микросервисами для практики в production-grade технологиях.
...
**Демо:**  Пользовательская часть (авторизация) в разработке.
...
✉️ dmitry.morozov.dev@gmail.com | 🔗 linkedin.com/in/dmitry-morozov-dev | 🌍 t.me/dmitry_morozov_dev | GitHub: Dmitry-Morozov-Dev
